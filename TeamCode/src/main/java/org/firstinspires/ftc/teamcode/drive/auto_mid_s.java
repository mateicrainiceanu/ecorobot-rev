...
@Autonomous(name = "Auto TauS")
@Disabled
public class auto_mid_s extends LinearOpMode{
...
//                }
    ...
    public void con_1()
    {
        ...
        Stop_Reset();
        EncoderPower(48,0.5,'t');
        Stop_Reset();
        EncoderPower(128,0.5,'l');
        intaked.setPower(0);
        intakes.setPower(0);
        Stop_Reset();
        EncoderPower(20,0.5,'f');
        EncoderPower(32,0.2,'f');
        brat1.setTargetPosition(2050);
        brat1.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        brat1.setPower(0.85);
        Stop_Reset();
    ...
    public void ciclu_high()
    {
        ...
        EncoderPower(99,0.5,'f');
        brat1.setTargetPosition(2200);
        brat1.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        brat1.setPower(0.85);
        while(brat1.isBusy() && opModeIsActive())
        {
