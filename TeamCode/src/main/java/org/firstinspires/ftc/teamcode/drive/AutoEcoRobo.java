...
@Autonomous(name = "AutoEcoRobo")
public class AutoEcoRobo extends LinearOpMode {
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        if (updatedRecognitions.size() != 0) {
                            ...
                            Stop_Reset();
                            sleep(1000);
                            if(Reglaj(recognition.getLeft()) && !reglat)
                            {
                            ...
                            if(reglat)
                            {
                                ...
                                if (recognition.getLabel() == "doza") {
                                    Stop_Reset();
                                    EncoderPower((int) (225 - recognition.getTop()), 0.2, 'f');
                                }
                                else if (recognition.getLabel() == "sticla") {
                                    Stop_Reset();
                                    EncoderPower((int) (200 - recognition.getTop()), 0.2, 'f');
                                }
                                else {
                                    Stop_Reset();
                                    EncoderPower((int) (200 - recognition.getTop()), 0.2, 'f');
    ...
    {
       if(stanga>230 || stanga<170)
       {
           Stop_Reset();
           EncoderPower((int)((stanga-200)/60),0.7, 'r');
           return false;
       }
       else
           return true;
