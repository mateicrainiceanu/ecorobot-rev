...
@Autonomous(name = "Auto Roar PurigulozD")
@Disabled
public class auto_puriguloz_d extends LinearOpMode{
    ...
    public void con_1()
    {
        ...
        EncoderPower(134,1,'f');
        Stop_Reset();
        EncoderPower(10,0.5,'b');
        Stop_Reset();
        EncoderPower(49,0.75,'a');
        Stop_Reset();
        EncoderPower(25,0.5,'f');
        EncoderPower(35,0.2,'f');
        brat1.setTargetPosition(2900);
        brat1.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        brat1.setPower(0.85);
        Stop_Reset();
        EncoderPower(5,0.4, 'r');
    ...
    public void Parcare_caz()
    {
        ...
        if(Caz=="3 Caz")
        {
            //check
            Stop_Reset();
            EncoderPower(90, 0.75, 'b');
            requestOpModeStop();
        }
        else if(Caz=="1 Caz")
        { //check
            Stop_Reset();
            EncoderPower(30, 0.75, 'f');
            requestOpModeStop();
        }
        else
        { //check
            Stop_Reset();
            EncoderPower(30, 0.75, 'b');
            requestOpModeStop();
        }
    }
