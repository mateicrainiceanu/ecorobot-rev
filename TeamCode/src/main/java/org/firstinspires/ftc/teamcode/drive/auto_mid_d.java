...
@Autonomous(name = "Auto TauD")
@Disabled
public class auto_mid_d extends LinearOpMode{
    ...
    public void con_1()
    {
        ...
        EncoderPower(31,0.2,'f');
        brat1.setTargetPosition(2050);
        brat1.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        brat1.setPower(0.85);
        Stop_Reset();
        EncoderPower(12,0.4, 'l');
